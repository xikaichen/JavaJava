public class Solution {
    public double findMedianSortedArrays(int[] nums1, int[] nums2) {
        ...
        if (len % 2 == 1) {
            ...
            return (findMedianSortedArrays(nums1, 0, nums2, 0, len / 2) + 
                findMedianSortedArrays(nums1, 0, nums2, 0, len / 2 + 1)) / 2.0;
        }
    }
    
    private int findMedianSortedArrays(int[] nums1, int start1, int[] nums2, int start2, int k) {
